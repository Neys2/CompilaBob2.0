  ...
  final public void Codigo() throws ParseException {
    ...
    case INICIO:
      jj_consume_token(INICIO);
                   Compilabob.pw.println("int main()");
      break;
    default:
      jj_la1[0] = jj_gen;
      ErrorNoinicio();
...
// DATOS Y OPERADORES USADOS EN SENTENCIAS
  final public void DataType() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NUMERO:
      var = jj_consume_token(NUMERO);
      break;
    case NUMDECIMAL:
      var = jj_consume_token(NUMDECIMAL);
      break;
    case EST_LOGIC:
      var = jj_consume_token(EST_LOGIC);
      break;
    case CADENAS:
      jj_consume_token(CADENAS);
      break;
  ...
  final public void Variable_dato() throws ParseException {
    if (jj_2_6(3)) {
      jj_consume_token(ENTERO);
          Compilabob.pw.print("int ");
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case FLOTANTE:
        jj_consume_token(FLOTANTE);
               Compilabob.pw.print("float ");
        break;
      case ID_CADENA:
        jj_consume_token(ID_CADENA);
               Compilabob.pw.print("string ");
        break;
      case BOOLEANO:
        jj_consume_token(BOOLEANO);
              Compilabob.pw.print("bool ");
        break;
      default:
        jj_la1[35] = jj_gen;
        jj_consume_token(-1);
...
//GRAMATICAS DE ERROR PARA LA ESTRUCTURA DEL CODIGO COATL
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10,0x8000,0x10000,0x20,0x20b40,0x20000,0x20b40,0x20000,0x0,0x0,0x0,0x0,0x20b40,0x20b40,0x20000,0x0,0x20b40,0x20000,0x20b40,0x20000,0x80000,0x20000,0x40003000,0x60000000,0x60000000,0x80000000,0x80000000,0x40002000,0x2000,0x0,0x0,0x0,0x9f00000,0x6000000,0xe0000000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0xc3c,0x0,0xc00,0x0,0x500,0x500,0x500,0x500,0xc3c,0xc3c,0x0,0x7c0,0xc3c,0x0,0xc3c,0x0,0x0,0x0,0x7c0,0x0,0x0,0x3,0x3,0x7c0,0x7c0,0x400,0x3c0,0x3c0,0x0,0x0,0x3,0x38,};
   }
